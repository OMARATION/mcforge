    ...
    public class CmdPermissionBuild : Command
    {
        ...
        public override void Use(Player p, string message)
        {
            ...
            if (number == 1)
            {
                ...
                if (p.level.permissionbuild > p.group.Permission) { Player.SendMessage(p, "You cannot change the perbuild of a level with a perbuild higher than your rank."); return; }
