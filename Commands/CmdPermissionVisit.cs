    ...
    public class CmdPermissionVisit : Command
    {
        ...
        public override void Use(Player p, string message)
        {
            ...
            if (number == 1)
            {
                ...
                if (p.level.permissionbuild > p.group.Permission) { Player.SendMessage(p, "You cannot change the pervisit of a level with a pervisit higher than your rank."); return; }
